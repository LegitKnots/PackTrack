// Full EditProfileScreen with modal, form, image upload, and structured error handling
    ...
    const fetchProfile = async () => {
        try {
            ...
            showCustomModal("Error", err.message || "Failed to load profile", [
                { text: "OK", onPress: () => { setShowModal(false); navigation.goBack() } }
            ])
        } finally {
            setLoading(false)
        }
                    ...
                    <TouchableOpacity onPress={selectProfilePicture} disabled={uploading}>
                        <View style={styles.avatarContainer}>
                            ...
                            <View style={styles.editAvatarButton}>
                                {uploading ? <ActivityIndicator size="small" color="#fff" /> : <MaterialIcons name="camera-alt" size={16} color="#fff" />}
                            </View>
                        </View>
                    </TouchableOpacity>
